"""API for Mammotion Luba bound to Home Assistant OAuth."""
...
class ConfigEntryAuth(my_pypi_package.AbstractAuth):
    """Provide Mammotion Luba authentication tied to an OAuth2 based config entry."""
    ...
    def __init__(
        ...
        """Initialize Mammotion Luba Auth."""
        self.hass = hass
        self.session = oauth_session
        super().__init__(self.session.token)

    def refresh_tokens(self) -> str:
        """Refresh and return new Mammotion Luba tokens using Home Assistant OAuth2 session."""
